...
- Find a way to set up an artifactory on our server or find somebody willing to host it and deprecate this repository. Potential options:
...
- Run CI with full package rebuild on schedule (weekly? monthly?) to detect regressions or breaking changes in CI / used recipes.
